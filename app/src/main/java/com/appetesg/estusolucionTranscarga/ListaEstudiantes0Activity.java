...
ListView mListView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ListaEstudiantes0Activity.this, MenuRutaActivity.class);
        ...
        TextView lblTextoToolbar = (TextView) toolbar.findViewById(R.id.
                lblTextoToolbar);
        lblTextoToolbar.setText("Recoger (mañana) - App SisColint "+ getResources().getString(R.string.versionApp));
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(ListaEstudiantes0Activity.this,EstadosDialogoActivity.class);
    ...
    public class ListarEstudiantesAsyncTask extends AsyncTask<Integer,Integer,ArrayList<ListaEstudiantes>> {
        ...
        protected void onPostExecute(ArrayList<ListaEstudiantes> s) {
            ...
            ListaEstudiantesAdapter mAdapter = new ListaEstudiantesAdapter(ListaEstudiantes0Activity.this,s);
            mListView.setAdapter(mAdapter);
            mListView.invalidateViews();
            lblTotalRegistros.setText("Total de estudiantes: "+String.valueOf(listaEstudiantes.size()));
        }

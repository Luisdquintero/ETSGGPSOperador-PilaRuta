...
public class Menuotros extends AppCompatActivity {
    GridView mGridView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //iniciamos la bd
        //usdbh = new Db(Menuotros.this, getResources().getString(R.string.name_bd), null, Integer.parseInt(getResources().getString(R.string.version_database)));
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Menuotros.this, MenuActivity.class);
        ...
        lblTextoToolbar.setText("Otros / Transporte - App SisColint " + getResources().getString(R.string.versionApp));
        ...
        items.add(new MenuPrincipal(12,R.drawable.icono_carro,"Servicios"));
        items.add(new MenuPrincipal(13,R.drawable.interview,"Lista de servicios"));
        /*items.add(new MenuPrincipal(8, R.drawable.carga,"Guias"));
        items.add(new MenuPrincipal(9, R.drawable.carga,"Registro Guias"));
        items.add(new MenuPrincipal(10, R.drawable.carga,"Transmitir"));
        ...
        mGridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
               ...
               if (m.getId() == 10) //transmite las guias en estatus pendiente = 1 y las borramos de la bd
                {
                    if(hasConnection(Menuotros.this))
                    {
                        get_guias_offline();
                    }
                    else
                    {
                        Toast.makeText(Menuotros.this,"Conectese a internet para poder transmitir las guias completas",Toast.LENGTH_LONG).show();
                    }

                }
                if (m.getId() == 1) {
                    Intent intent = new Intent(Menuotros.this, BrujulaActivity.class);
                    startActivity(intent);
                    finish();
                }
                if (m.getId() == 2) {
                    Intent intent = new Intent(Menuotros.this, ListadoAgendaActivity.class);
                    startActivity(intent);
                    finish();
                }
                if (m.getId() == 5) {
                    //if(NetworkUtil.hayInternet(this.getActivity())) {
                    Intent intent = new Intent(Menuotros.this, ListadoPreguntas.class);
                    startActivity(intent);
                    finish();
                    /*}
                    else{
                ...
                if (m.getId()==7){
                    if(NetworkUtil.hayInternet(Menuotros.this)){
                        Intent intent = new Intent(Menuotros.this,ListaRutaActivity.class);
                        startActivity(intent);
                        finish();
                    }else{
                ...
                if (m.getId() == 6) {
                    //if(NetworkUtil.hayInternet(this.getActivity())) {
                    Intent intent = new Intent(Menuotros.this, ListadoPreguntasPesv.class);
                    startActivity(intent);
                    finish();
                   /* }
                    else
                ...
                if(m.getId() == 7)  {
                    if(NetworkUtil.hayInternet(Menuotros.this)) {
                        Intent intent = new Intent(Menuotros.this, ListaFiltrosActivity.class);
                        startActivity(intent);
                        finish();
                    }
                    else{
              ...
              if(m.getId() == 8)  {
                    Intent intent = new Intent(Menuotros.this, HistoricoGuia.class);
                    startActivity(intent);
                    finish();
                }
                if(m.getId() == 9)  {
                    Intent intent = new Intent(Menuotros.this,ListaCiudadesD.class);
                    //Intent intent = new Intent(Menuotros.this,ListaEnviosProd.class);
                    startActivity(intent);
                    finish();
                }
                if(m.getId() == 11) {
                    Intent intent = new Intent(Menuotros.this,ListaCiudadesCotizacion.class);
                    startActivity(intent);
                }
                if (m.getId()==12){
                    Intent intent = new Intent(Menuotros.this,ServiciosActivity.class);
                    startActivity(intent);
                }

                if (m.getId()==13){
                    Intent intent = new Intent(Menuotros.this,ListaServiciosActivity.class);
                    startActivity(intent);
                }
            ...
            try {
                ...
                if (db != null) {
                    ...
                    if (c.getCount() > 0) {
                        ...
                        if (c.moveToFirst()) {
                            Toast.makeText(Menuotros.this,"Espere un momento,la app esta enviando la información al servidor",Toast.LENGTH_LONG).show();
                            do {
                            ...
                            Toast.makeText(Menuotros.this,"Información enviada correctamente",Toast.LENGTH_LONG).show();
                        }
                    }
                    //es en esta
...
/*
    ...
    public class SendTemperaturaAsyncTask extends AsyncTask<Integer, Integer, String>
    {
        ...
        protected void onPreExecute() {
            ...
            //      "Transmitiendo Informacion...", true, false);
            // Start a new thread that will download all the data
            p = new ProgressDialog(Menuotros.this);
            p.show(Menuotros.this, "Procesando...", "por esperar un momento.",false);
        }
        //Metodo en string

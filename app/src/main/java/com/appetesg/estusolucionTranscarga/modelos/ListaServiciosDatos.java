...
public class ListaServiciosDatos {
    ...
    public ListaServiciosDatos(String numServi, String tipoServi, String strFechaServi) {
        this.numServi = numServi;
        this.tipoServi = tipoServi;
        this.strFechaServi = strFechaServi;
    }

    public ListaServiciosDatos(String tipoServi, double latitudServi, double longitudServi, String strFechaServi) {
        this.tipoServi = tipoServi;

    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ListaChequeoActivity.this, Menuotros.class);
        ...
        btnValidar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(NetworkUtil.hayInternet(ListaChequeoActivity.this))
                {
                    ...
                    new ListaChequeoActivity.ServiciosAsyncTask(idUsuario, StrTecnomecanica, StrPreventiva, StrSoat, StrLlantas, StrCarretera).execute();
                }else{
    ...
    public  class ServiciosAsyncTask extends AsyncTask<Integer,Integer,String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if (s.equalsIgnoreCase("True") || s.equalsIgnoreCase("true")){
                ...
                Intent intent = new Intent(ListaChequeoActivity.this,MenuActivity.class);

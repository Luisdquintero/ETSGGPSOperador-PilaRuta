...
public class ListaEstudiantes901Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ListaEstudiantes901Activity.this, MenuRutaActivity.class);
        ...
        TextView lblTextoToolbar = (TextView) toolbar.findViewById(R.id.
                lblTextoToolbar);
        lblTextoToolbar.setText("Recoger(tarde) - App SisColint "+ getResources().getString(R.string.versionApp));
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(ListaEstudiantes901Activity.this,EstadosDialogoActivity.class);
                intent.putExtra("idEstCambio",idEstudiante);
                intent.putExtra("flagEstado",901);
    ...
    public class ListarEstudiantesAsyncTask extends AsyncTask<Integer,Integer,ArrayList<ListaEstudiantes>> {
        ...
        protected void onPostExecute(ArrayList<ListaEstudiantes> s) {
            ...
            ListaEstudiantesAdapter mAdapter = new ListaEstudiantesAdapter(ListaEstudiantes901Activity.this,s);

...
public class ListaPreguntasAdapterPesv extends BaseAdapter {
    private ArrayList<PreguntaPesv> questionsList;
    private LayoutInflater inflter;

    public ListaPreguntasAdapterPesv(Context applicationContext, ArrayList<PreguntaPesv> questionsList) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        final PreguntaPesv preguntaActual = (PreguntaPesv) getItem(i);

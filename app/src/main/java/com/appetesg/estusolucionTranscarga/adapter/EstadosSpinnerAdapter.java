...
public class EstadosSpinnerAdapter extends BaseAdapter {
    ...
    protected ArrayList<Estado> items,itemsFiltrados;
    Estado mEstado;
    ListaServicioAdapter.ViewHolder holder=new ListaServicioAdapter.ViewHolder();
    String TAG="FiltroSpinnerAdapter";

    public EstadosSpinnerAdapter(AppCompatActivity activity, ArrayList<Estado> items) {
        super();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.lblSpinner.setText(mEstado.getNomEstado());
